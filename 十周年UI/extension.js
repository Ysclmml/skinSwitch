	...
	window.dui = window.decadeUI = {
		...
		initOverride:function(){
			...
			var Player = (function(Player){
				...
				// 	var shen;
				// 	if (character && duicfg.showJieMark) {
				// 		if (lib.characterPack.extra)
				// 			shen = lib.characterPack.extra[character];
				// 		if (shen == null) {
				// 			shen = character.substr(0, 4);
				//
				// 		}
				//
				// 		if (shen != null) {
				// 			shen = lib.translate[character][0];
				// 			if (shen == '神') {
				// 				if (this.$jieMark == undefined)
				// 					this.$jieMark = dui.element.create('shen-mark', this);
				// 				else
				// 					this.appendChild(this.$jieMark);
				// 			}
				// 		}
				...
				// 	var sp;
				// 	if (character && duicfg.showJieMark) {
				// 		if (lib.characterPack.sp)
				// 			sp = lib.characterPack.sp[character];
				// 		if (sp == null) {
				// 			sp = character.substr(0, 4);
				// 			sp == 'sp_' || sp == 'jsp_' || sp == 'ns_';
				// 		}
				//
				// 		if (sp != null) {
				// 			sp = lib.translate[character].substr(0, 2);
				// 			if (sp == 'SP') {
				// 				if (this.$jieMark == undefined)
				// 					this.$jieMark = dui.element.create('sp-mark', this);
				// 				else
				// 					this.appendChild(this.$jieMark);
				// 			}
				// 		}
				...
				// 	var tw;
				// 	if (character && duicfg.showJieMark) {
				// 		if (lib.characterPack.tw)
				// 			tw = lib.characterPack.tw[character];
				// 		if (tw == null) {
				// 			tw = character.substr(0, 4);
				// 			tw == 'tw_';
				// 		}
				//
				// 		if (tw != null) {
				// 			tw = lib.translate[character].substr(0, 2);
				// 			if (tw == 'TW') {
				// 				if (this.$jieMark == undefined)
				// 					this.$jieMark = dui.element.create('tw-mark', this);
				// 				else
				// 					this.appendChild(this.$jieMark);
				// 			}
				// 		}
				...
				// 			old1 = lib.characterPack.old[character];
				// 		if (old1 == null) {
				// 			old1 = character.substr(0, 4);
				// 			old1 == 'old_' || old1 == 'ol_';
				// 		}
				//
				// 		if (old1 != null) {
				// 			old1 = lib.translate[character].substr(0, 1);
				// 			if (old1 == '旧' || old1 == 'OL') {
				// 				if (this.$jieMark == undefined)
				// 					this.$jieMark = dui.element.create('old1-mark', this);
				// 				else
				// 					this.appendChild(this.$jieMark);
				// 			}
				// 		}
				...
				// 	if (jie == '界' || shen == '神') {
				// //	if (jie == '界' || shen == '神' || old1 =='旧' || old1 == 'OL') {
				// //	if (jie == '界' || shen == '神' || sp == 'SP' || sp == 'jsp') {
...
config:{
			"GXNR": {
				...
				"textMenu": function(node, link) {
					...
					switch (link) {
						case "xin":
							node.innerHTML = "<img style=width:280px src=" + lib.assetURL + "extension/十周年UI/gengxin/更新.jpg><br><img style=width:280px src=" + lib.assetURL + "extension/十周年UI/gengxin/更新1.jpg><br><img style=width:280px src=" + lib.assetURL + "extension/十周年UI/gengxin/更新2.jpg><br><img style=width:280px src=" + lib.assetURL + "extension/十周年UI/gengxin/更新3.jpg><br><img style=width:280px src=" + lib.assetURL + "extension/十周年UI/gengxin/更新4.jpg>";
							break;
					}
				},
			},
...
package:{
	...
	intro:(function(){
		var log = [
			...
			'- 修改/调试：南尋；',
			'- 参与测试: 阳光微凉；',
			'- 此魔改版十周年修改自（十周年UI v1.2.0.220114），调整部分代码；',
			'- 本人（南尋）修改此文件（十周年UI v1.2.0.220114）已得到短歌大佬同意并授权；',
			'- 本文件部分代码来自（玄武江湖），如有侵权或对作者造成不良影响，立删。',
		];
